...
| 🆕⑯ | 🔴 **KMS 키 6개의 정체** — 문서에 개수만 있고 **목록이 없다** | 세어보면 **5개**(Secrets Manager · EBS · S3 · EKS Secrets · CloudTrail) ≠ 기록된 6. 6번째 근거 없음 | 🔴 미결 (2026-08-11 발견) |
| 🆕⑰ | 🔴 **CMK($1/키) vs AWS 관리형 키($0)** — 판단 근거가 문서에 **없다** | C-57(단일 계정)이 CMK 논거 하나(**교차계정 공유 불가**)를 없앴다. 남는 근거 = 키 정책 자기 작성 · 삭제 방어 뿐. 차액 최대 **$6/월** | 🔴 미결 (2026-08-11 발견) |
