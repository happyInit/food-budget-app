...
> | | |
> |---|---|
> | **확정 결정** | **C-1 ~ C-57** (§0.1). ⚠️ CLAUDE.md 는 아직 "C-1~C-29" 로 적혀 있다 — **stale** |
...
> 반영 범위 = **C-1 ~ C-57** (2026-08-11 — 🔴 **계정 3개 → 1개**(C-57) · **Interface 엔드포인트 3종 채택**(C-56) · PG 복제 하이브리드(C-55) · DR 전환 2단(C-54)).
