...
> | | |
> |---|---|
> | **확정 결정** | **C-1 ~ C-87** (§0.1). 🟢 **CLAUDE.md 동기화 완료**(2026-08-13) — 범위 `C-1~C-87` · 선행 작업 실측(체크박스 182 / 고유 번호 163) · 대조표 `외부 LB` 를 **ALB(C-60)** 로 정정 |
...
> 반영 범위 = **C-1 ~ C-87** (2026-08-13 — 🔴 **Cilium ENI 모드**(C-82 → 파드 CIDR 소멸·`target-type: ip`) ·
