...
> | | |
> |---|---|
> | **확정 결정** | **C-1 ~ C-85** (§0.1). ⚠️ CLAUDE.md 는 아직 "C-1~C-29" 로 적혀 있고 **선행 작업 121건** 도 stale(실측 체크박스 160 · 번호 143) — 🔴 **대조표의 `외부 LB → NLB (ALB 기각)` 은 C-60 이 뒤집었다** |
...
> 반영 범위 = **C-1 ~ C-85** (2026-08-13 — 🔴 **Cilium ENI 모드**(C-82 → 파드 CIDR 소멸·`target-type: ip`) ·
