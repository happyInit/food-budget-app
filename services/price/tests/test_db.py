...
def test_parse_sentinels_enumerates_all_pods():
    ...
    spec = "mp-redis-s-0.mp-redis-s-hl.data.svc:26379, mp-redis-s-1.mp-redis-s-hl.data.svc:26379,mp-redis-s-2.mp-redis-s-hl.data.svc:26379,"
    assert _parse_sentinels(spec) == [
        ("mp-redis-s-0.mp-redis-s-hl.data.svc", 26379),
        ("mp-redis-s-1.mp-redis-s-hl.data.svc", 26379),
        ("mp-redis-s-2.mp-redis-s-hl.data.svc", 26379),
    ]
