    ...
    <div>
      ...
      <div style={{ maxWidth: 680, background: '#fff', border: '1px solid #E6E6E6', overflow: 'hidden', display: 'flex', flexDirection: 'column', height: 560 }}>
        <div style={{ flex: 1, padding: 20, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div style={{ alignSelf: 'flex-end', maxWidth: '75%', background: '#1FA463', color: '#fff', padding: '11px 15px', borderRadius: '0 14px 4px 14px', fontSize: 13.5, lineHeight: 1.5 }}>냉장고에 있는 재료로 3천원 안에 뭐 해먹지?</div>
          ...
          <div style={{ alignSelf: 'flex-start', maxWidth: '80%', background: '#fff', border: '1px solid #E6E6E6', padding: 12, display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            <button onClick={() => nav('/recipes/1')} style={{ padding: '7px 12px', border: 'none', background: '#1FA463', color: '#fff', fontSize: 12, fontWeight: 700, cursor: 'pointer' }}>보기</button>
          </div>
          <div style={{ alignSelf: 'flex-end', maxWidth: '75%', background: '#1FA463', color: '#fff', padding: '11px 15px', borderRadius: '0 14px 4px 14px', fontSize: 13.5, lineHeight: 1.5 }}>좋아, 장바구니에 담아줘</div>
        ...
        <div style={{ borderTop: '1px solid #E6E6E6', padding: '12px 16px', display: 'flex', gap: 10 }}>
          ...
          <button style={{ width: 42, height: 42, border: 'none', borderRadius: '50%', background: '#1FA463', color: '#fff', fontSize: 16, cursor: 'pointer' }}>↑</button>
        </div>
      </div>
    </div>
  )
