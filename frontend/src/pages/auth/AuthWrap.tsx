...
export default function AuthWrap({ children }: { children: ReactNode }) {
  return (
    <div style={{ minHeight: '100vh', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, background: 'linear-gradient(160deg,#FBF5EF 0%,#FFFFFF 60%)' }}>
...
export const primaryBtn: React.CSSProperties = { width: '100%', padding: 13, border: 'none', background: '#F26419', color: '#fff', fontSize: 14.5, fontWeight: 700, cursor: 'pointer' }
