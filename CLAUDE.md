...
> **운영·장애대응·접속의 정본은 이제 K8s 쪽**(`docs/mp_k8s_infra_status.md` §4.0 — kubectl·Grafana `:30300`·ArgoCD). `docs/docker-infra-status.md` 는 **호스트 C(Harbor·Jenkins·SonarQube) Docker 스택과 정지 VM 참조용으로만** 남는다(`.8`·`.9` 정지 2026-07-28~30, `.11` 철거 대기 — VM 해체 시 폐기).
